...
public class BaseActivity extends AppCompatActivity {
    ...
    protected final String[] permissionCamera = {Manifest.permission.CAMERA,  Manifest.permission.RECORD_AUDIO, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE};
